...
class C2(threading.Thread):
    ...
    def _setup_server(self):
        # directory containing flxroc modules
        modules = os.path.abspath('flxroc/modules')
        ...
        try:
            ...
            util.log("Serving FLXROC modules from {0} on port {1}...".format(modules, self.port + 1))
