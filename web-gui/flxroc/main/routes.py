...
from flxroc import client, c2
from flxroc.core.dao import file_dao, payload_dao, session_dao
from flxroc.users.forms import RegistrationForm, LoginForm, UpdateAccountForm
from flxroc.models import db, bcrypt, User, Session
from flxroc.utils import get_sessions_serialized, get_tasks_serialized

# Blueprint
main = Blueprint('main', __name__)

# Globals
OUTPUT_DIR = os.path.abspath('flxroc/output')
