...
'''
    ...
    if options.pastebin:
        ...
        dirs = ['modules/clients/payloads','flxroc/modules/clients/payloads','flxroc/flxroc/modules/clients/payloads']
        dirname = '.'
        for d in dirs:
            if os.path.isdir(d):
                dirname = d
...
def _stager(options, **kwargs):
    ...
    if options.pastebin:
        ...
        dirs = ['modules/clients/stagers','flxroc/modules/clients/stagers','flxroc/flxroc/modules/clients/stagers']
        dirname = '.'
        for d in dirs:
            if os.path.isdir(d):
                dirname = d
...
def _dropper(options, **kwargs):
    ...
    dirs = ['modules/clients/droppers','flxroc/modules/clients/droppers','flxroc/flxroc/modules/clients/droppers']
    dirname = '.'
    for d in dirs:
        if os.path.isdir(d):
            dirname = d

    name = 'flxroc_{}.py'.format(kwargs['var']) if not options.name else options.name
